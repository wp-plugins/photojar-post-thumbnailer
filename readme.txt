...
4. Optional: Customize the pj-post-thumb.php template and place it in your theme's directory (Ex: 'wp-content/themes/Default').
5. Optional: Install a javascript viewer plugin (Ex: [Lightbox](http://stimuli.ca/lightbox/), [ThickBox](http://mezzomondo.nelblog.it/2007/05/28/thickbox3/), etc.) 
...
1. Thumbnail setting from the Edit Post page.
2. Example post thumbanil.
3. PhotoJAR: Post Thumbnail settings